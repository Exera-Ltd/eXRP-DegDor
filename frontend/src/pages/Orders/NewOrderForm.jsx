...
import TransactionTable from './OrderTable';
...
const NewOrderForm = ({ orderData, isReadOnly = false, setIsReadOnly = () => { }, setIsTransactionModalVisible = () => { } }) => {
    const { user } = useUser();
    ...
    const showCustomerModal = (customerId) => {
        console.log(customerId);
        if (customerId != null) {
    ...
    >
        ...
        <Row gutter={24} style={{ alignItems: 'baseline' }}>
            ...
            <Col span={2}>
                <PlusCircleOutlined style={{ fontSize: 20 }} onClick={() => showCustomerModal(null)} />
            </Col>
            <Form.Item
                name="customer_id"
                hidden
            ...
            >
                <NewOrderForm orderData={selectedTransactionData} isReadOnly={true} />
            </Modal>
        </Row>
        ...
        <Modal
            ...
            footer={null}
        >
            <NewCustomerForm customerData={selectedCustomerData} onCustomerAdded={fetchCustomers} closeModal={closeCustomerModal} />
        </Modal>
        {
            !isReadOnly &&
